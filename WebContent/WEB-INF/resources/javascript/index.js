...
function processUserSelectionData(whatToProcess,dataToProcess){
	...
	case 'LOGGER_FORM_KEYPRESS':
		...
		case 'Shift_R': //FF ICONIC PLAYERS
			switch ($('#selected_broadcaster').val()){
			case 'PSL': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN':
				$("#captions_div").hide();
				$("#cancel_match_setup_btn").hide();
				$("#expiry_message").hide();
				$("#auction_div").hide();
		...
		case 's': // LOF SQUAD SIZE
			...
			case 'RALLY':
				...
				$("#expiry_message").hide();
				$("#auction_div").hide();
				processAuctionProcedures('SPLIT_GRAPHICS-OPTIONS');
				break;	
			default://ISPL
		...
		case 'l': //LOF SQUAD
			switch ($('#selected_broadcaster').val()){
			case 'RALLY':
				processAuctionProcedures('POPULATE-LOCATION');
				break;
			default://ISPL
				$("#captions_div").hide();
				$("#cancel_match_setup_btn").hide();
		...
		case 'x':
			...
			case 'RALLY':
				...
				$("#expiry_message").hide();
				$("#auction_div").hide();
				processAuctionProcedures('NAMESUPERSS_GRAPHICS-OPTIONS');
				break;	
			default://ISPL
				$("#captions_div").hide();
				$("#cancel_match_setup_btn").hide();
		...
		case 'm': //LT ICONIC PPLAYERS
			...
			switch ($('#selected_broadcaster').val()){
			case 'KCL': case 'VCL': case 'ILT20': case 'ADT10': case 'PWL': case 'MUMBAI_T20_VIZ': case 'MUMBAI_T20_BIGSCREEN':
		...
		case 'b': //LT PLAYER PROFILE STATS
			...
			case 'RALLY':
				...
				$("#expiry_message").hide();
				$("#auction_div").hide();
				addItemsToList('BACKG-OPTIONS',null);
				break;
			default://ISPL
				$("#captions_div").hide();
				$("#cancel_match_setup_btn").hide();
		...
		case 'p': //ZONE PLAYERS CHANGE ON
			...
			case 'RALLY':
				...
				$("#expiry_message").hide();
				$("#auction_div").hide();
				processAuctionProcedures('SPLITPIP_GRAPHICS-OPTIONS');
				break;
			case 'ADT10':
				$("#captions_div").hide();
				$("#cancel_match_setup_btn").hide();
				$("#expiry_message").hide();
				$("#auction_div").hide();
				addItemsToList('PICKORDER-OPTIONS',null);
				break;	
			default://ISPL
...
{	
	...
	case 'selectTeamData':
		lastSelectedInput = whichInput;
		processAuctionProcedures('ADTTEAMS_GRAPHICS-OPTIONS');
		break;	
	...
	case 'populate_ff_big_playerprofile_btn': case 'populate_backg_btn': case 'populate_ff_playerprofile_draft_btn': case 'populate_roundsummary_draft_btn': case 'populate_pick_order_btn':
		...
		case 'populate_split_btn':
			processAuctionProcedures('POPULATE-L3-SPLIT');
			break;	
		case 'populate_splitpip_btn':
			processAuctionProcedures('POPULATE-L3-SPLITPIP');
			break;	
		case 'populate_namesuperss_btn':
			processAuctionProcedures('POPULATE-L3-NAMESUPERSS');
			break;
		case 'populate_backg_btn':
			processAuctionProcedures('POPULATE-BACKG');
			break;		
		...
		case 'populate_playerprofile_btn':
			...
			break;
		case 'populate_ff_playerprofile_draft_btn':
			processAuctionProcedures('POPULATE-PLAYERPROFILE_DRAFT_FF');
			break;
	...
	case 'select_broadcaster':
		...
		case 'HANDBALL': case 'ISPL': case 'PSL':
			...
			break;
		case	 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN':
...
function processAuctionProcedures(whatToProcess)
{
	...
	case 'POPULATE-L3-SPLIT':
		...
		case 'ISPL_VIZ':
			...
			break;
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': 
		case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
			valueToProcess = $('#selectSplit option:selected').val() + ',' + $('#selectLogo option:selected').val();
			break;
		}
		break;
	...
	case 'POPULATE-BACKG':
		switch ($('#selected_broadcaster').val().toUpperCase()) {
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ":  case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'VCL': case 'ILT20': case 'ADT10': case 'RALLY': 
	...
	case 'POPULATE-L3-CRWLERFREETEXT':
		switch ($('#selected_broadcaster').val().toUpperCase()) {
		case 'VIZ_ISPL_2024':  case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': 
		case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
			valueToProcess = $('#selectFlipper option:selected').val();
			break;
		}
		break;
	...
	case 'POPULATE-PLAYERPROFILE_FF': case 'POPULATE-PROFILE_FF': case 'POPULATE-PLAYERPROFILE_FF_BIG':
		switch ($('#selected_broadcaster').val().toUpperCase()) {
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'VCL': case 'ILT20':
		case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20':  case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
	...
	case 'POPULATE-FF-PLAYERPROFILE':
		...
		case 'ISPL_VIZ':
			...
			break;
		case 'VIZ_ISPL_2024': case 'PSL': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'KCL': 
		case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL': case 'VCL': case 'ILT20': case 'ADT10':
	...
	case "POPULATE-SQUAD-PLAYER":
		switch ($('#selected_broadcaster').val().toUpperCase()) {	
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'VCL': case 'ILT20': case 'ADT10': case 'MUMBAI_T20_BIGSCREEN': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
			valueToProcess = $('#selectTeamName option:selected').val();
			break;
		}
		break;
	...
	case 'POPULATE-GOOGLY_POWER':
		switch ($('#selected_broadcaster').val().toUpperCase()){
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
			valueToProcess = $('#selectTeamName option:selected').val();
			break;
		}
		break;
	...
	case "POPULATE-PROFILE_STATS_CHANGE":
		switch ($('#selected_broadcaster').val().toUpperCase()){
		case 'VIZ_ISPL_2024': case 'PSL': case "UTT_VIZ": case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'VCL': case 'ILT20': case 'ADT10': case 'RALLY':case 'MUMBAI_T20_BIGSCREEN':  case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
	...
	$.ajax({    
        ...
        success : function(data) {
			...
			case 'SPLIT_GRAPHICS-OPTIONS':
				addItemsToList('SPLIT-OPTIONS',data);
				match_data = data;
				break;	
			
			case 'SPLITPIP_GRAPHICS-OPTIONS':
				addItemsToList('SPLITPIP-OPTIONS',data);
				match_data = data;
				break;		
			case 'NAMESUPERSS_GRAPHICS-OPTIONS':
				addItemsToList('NAMESUPERSS-OPTIONS',data);
				match_data = data;
				break;	
			...
			case 'PLAYERPROFILE_GRAPHICS-OPTIONS': 
				...
				match_data = data;
				break;
			case 'ADTTEAMS_GRAPHICS-OPTIONS':
				addItemsToList('ADTTEAMS-OPTIONS',data);
				break;	
			...
			case 'POPULATE-FF_TOP_BUY_TEAM': case 'POPULATE-FF_RETAIN_PLAYERS': case "POPULATE-FF_SQUAD_ROLE_TEAM": case 'POPULATE-BACKG':
				if(confirm('Animate In?') == true){
					...
					case 'POPULATE-LOF_SQUAD':
						...
						break;
					case 'POPULATE-BACKG':
						processAuctionProcedures('ANIMATE-IN-BACKG');
						break;	
			...
			case 'POPULATE-L3-FLIPPER': case 'POPULATE-L3-FLIPPER_TEXT': case 'POPULATE-PLAYERPROFILE_DRAFT_FF':
				...
				if(whatToProcess == 'POPULATE-RTM_ENABLED' || whatToProcess == 'POPULATE-CURR_BID' || whatToProcess == 'POPULATE-RTM_PLAYER')	{
					...
					if(confirm('Animate In?') == true){
						...
						case 'POPULATE-LOCATION':
							processAuctionProcedures('ANIMATE-IN-LOCATION');
							break;	
						case 'POPULATE-RIGHT_SUPER':
							processAuctionProcedures('ANIMATE-IN-RIGHTSUPER');
							break;
						case 'POPULATE-L3-SPLIT':	
						...
						case 'POPULATE-PLAYERPROFILE_FF':
							...
							break;
						case 'POPULATE-PLAYERPROFILE_DRAFT_FF':
							processAuctionProcedures('ANIMATE-IN-PLAYERPROFILE_DRAFT_FF');
							break;
...
function addItemsToList(whatToProcess, dataToProcess)
{
	...
	case 'POPULATE-TEAM':
		...
		break;
	case 'ADTTEAMS-OPTIONS':
		var whichInput = lastSelectedInput;
		var row = $(whichInput).closest('tr')[0];

		// Remove any existing team dropdown first, so toggling is clean
		var existingTeamSelect = document.getElementById('selectTeamName');
		if (existingTeamSelect) {
			$(existingTeamSelect).closest('td').remove();
		}

		if ($(whichInput).val().toUpperCase() === 'WITH_TEAM') {

			var teamSelect = document.createElement('select');
			teamSelect.style = 'width:150px';
			teamSelect.id = 'selectTeamName';
			teamSelect.name = teamSelect.id;

			// Populate with your actual team list
			dataToProcess.forEach(function(team,index,arr1) {
				var opt = document.createElement('option');
				opt.value = team.teamId;
				opt.text = team.teamName1;
				teamSelect.appendChild(opt);
			});

			teamSelect.setAttribute('onchange', "processUserSelection(this)");

			var newCell = row.insertCell(row.cells.length-1);
			newCell.appendChild(teamSelect);
		}
		break;	
		...
		case 'UTT_BIGSCREEN': case "UTT_VIZ": case 'MUMBAI_T20_VIZ': case 'RALLY':  case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL': case 'VCL': case 'ILT20': case 'ADT10':
			...
			switch(whatToProcess){
				...
				case 'BACKG-OPTIONS':
					...
					option = document.createElement('option');
					option.value = 'NAYA_CHAPTER';
					option.text = 'INDIA KA NAYA CHAPTER';
					select.appendChild(option);
					
					option = document.createElement('option');
					option.value = 'COUNT_COUNTINUES';
					option.text = 'THE COUNT COUNTINUES';
					select.appendChild(option);
					
					option = document.createElement('option');
					option.value = 'CHHATRON_KI_KHOJ';
					option.text = 'CHHATRON KI KHOJ';
					select.appendChild(option);
					
					option = document.createElement('option');
					option.value = 'CHHATRON_KI_KHOJ_RIGHT_BACK';
					option.text = 'CHHATRON KI KHOJ RIGHT BACK';
					select.appendChild(option);
				...
				case 'ZONE-PLAYER-OPTIONS': case 'ZONEWISE_PLAYER_SOLD-OPTIONS': case 'ZONE-PLAYER_FULL-OPTIONS':
					...
					switch ($('#selected_broadcaster').val().toUpperCase()) {
						case 'UTT_VIZ': case'UTT_BIGSCREEN':
							...
							select.appendChild(option);
							break;
						case 'KCL': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
				...
				case 'SQUAD_ANIMATION-OPTIONS': case 'RETAIN_PLAYERS-OPTIONS': case 'TEAMS-OPTIONS':
					switch ($('#selected_broadcaster').val().toUpperCase()) {
						...
						break;
				case 'FLIPPER_TEXT-OPTIONS': case 'FREETEXT-OPTIONS':
					switch ($('#selected_broadcaster').val().toUpperCase()){
						case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
							select = document.createElement('select');
							select.style = 'width:130px';
				...
				case 'FLIPPER-OPTIONS':
					...
					case "UTT_VIZ":  case 'UTT_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL':
						select = document.createElement('select');
						select.style = 'width:130px';
						select.id = 'selectFlipper';
						select.name = select.id;
			...
			case 'NAMESUPER_PLAYER-OPTIONS':
				...
				case 'PLAYERPROFILE_DRAFT-OPTIONS':
					switch ($('#selected_broadcaster').val().toUpperCase()) {
						case 'ADT10': 
						select = document.createElement('select');
						select.style = 'width:180px';
						select.id = 'selectDraftRound';
						select.name = select.id;
			...
			case 'PLAYERPROFILE_MAIN-OPTIONS':
				switch ($('#selected_broadcaster').val().toUpperCase()) {
					...
					case 'VCL': case 'ILT20': case 'ADT10': case 'MUMBAI_T20_BIGSCREEN': case 'KCL': case 'PWL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN':
						select = document.createElement('select');
			...
			case 'FF_PLAYERPROFILE-OPTIONS': case 'LT_PLAYERPROFILE-OPTIONS': case 'PROFILEFF-OPTIONS': case 'PLAYERPROFILE-OPTIONS': case 'FF_BIG_PLAYERPROFILE-OPTIONS':
				switch ($('#selected_broadcaster').val().toUpperCase()) {
					case 'HANDBALL': case 'ISPL': case 'ISPL_VIZ': case 'VIZ_ISPL_2024': case 'PSL': case 'UTT_BIGSCREEN': case "UTT_VIZ": case 'MUMBAI_T20_VIZ': 
					case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'KCL': case 'VCL': case 'ILT20': case 'ADT10':  case 'PWL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN':
						select = document.createElement('select');
						select.id = 'selectPlayerName';
						select.name = select.id;
						...
						if(whatToProcess.toUpperCase()==='FF_PLAYERPROFILE-OPTIONS'){
							...
							case 'ADT10':
								...
								option = document.createElement('option');
								option.value = 'WITHOUT_TEAM';
								option.text = 'WITHOUT TEAM';
								select.appendChild(option);
																
								option = document.createElement('option');
								option.value = 'WITH_TEAM';
								option.text = 'WITH TEAM';
								select.appendChild(option);
						...
						case 'HANDBALL': case 'ISPL': case 'ISPL_VIZ': case 'VIZ_ISPL_2024': case 'UTT_BIGSCREEN': case 'PSL': case "UTT_VIZ": case 'MUMBAI_T20_BIGSCREEN': case 'MUMBAI_T20_VIZ': case 'RALLY': 
						       switch(whatToProcess){
								case 'FF_PLAYERPROFILE-OPTIONS': case 'PROFILEFF-OPTIONS':
									...
									switch ($('#selected_broadcaster').val().toUpperCase()){
									case 'ISPL': case 'ISPL_VIZ': case 'VIZ_ISPL_2024': case 'MUMBAI_T20_VIZ': case 'RALLY': case 'MUMBAI_T20_BIGSCREEN':
								...
								case 'LT_PLAYERPROFILE-OPTIONS':
									...
									else if(broadcaster === 'KCL' || broadcaster === 'VCL' || broadcaster === 'ILT20' || broadcaster === 'ADT10' || broadcaster === 'VCL_BIGSCREEN' || broadcaster === 'ILT20_BIGSCREEN' 
									...
									} else if(broadcaster === 'MUMBAI_T20_VIZ' || broadcaster === 'RALLY'){
			...
			case 'LT_PP_STATS-OPTIONS':
				...
				$('#selected_broadcaster').val().toUpperCase() === 'VCL'){
				...
				if($('#selected_broadcaster').val().toUpperCase()==='KCL' || $('#selected_broadcaster').val().toUpperCase()==='VCL' || $('#selected_broadcaster').val().toUpperCase()==='PWL'){
			...
			case 'LOF_REMAINING_PURSE-OPTIONS':
				switch ($('#selected_broadcaster').val().toUpperCase()) {
				case 'VIZ_ISPL_2024': case 'PSL': case 'UTT_BIGSCREEN': case "UTT_VIZ": case 'MUMBAI_T20_VIZ': 
				case 'RALLY': case 'MUMBAI_T20_BIGSCREEN': case 'VCL': case 'ILT20': case 'ADT10': case 'KCL': case 'KCL_BIGSCREEN': case 'VCL_BIGSCREEN': case 'ILT20_BIGSCREEN': case 'PWL': 
				case 'UTT_VIZ':
					select = document.createElement('select');
			...
			case 'SPLIT-OPTIONS':
			    ...
			    option.value = 'Populate Split';
				break;
			case 'SPLITPIP-OPTIONS':
				option.name = 'populate_splitpip_btn';
			    option.value = 'Populate Split Single';
				break;		
			case'NAMESUPERSS-OPTIONS':
			    option.name = 'populate_namesuperss_btn';
			    option.value = 'Populate Namesuper';
				break;
			case 'BACKG-OPTIONS':
				option.name = 'populate_backg_btn';
			    option.value = 'Populate BG';
				break;		
			case 'FLIPPER-OPTIONS':

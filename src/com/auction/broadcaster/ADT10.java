...
import com.auction.model.TeamWise;
import com.auction.service.AuctionService;
import com.auction.model.Auction;
import com.auction.model.DraftedPlayer;
...
public class ADT10 extends Scene{

	private String status, side2ValueToProcess = "";
	private String slashOrDash = "-";
	public String session_selected_broadcaster = "ADT10";
	...
	public ADT10(String scene_path, String which_Layer) {
		...
		for(int i=auction.getPlayers().size()-1; i >= 0; i--) {
			if(playerId == auction.getPlayers().get(i).getPlayerId()) {
				...
				if(which_side == 2) {
					...
					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$gfx_ScoreBug$MoveForStats$StatsGrp$Side" + which_side + "$Double_Data$txt_Age*GEOM*TEXT SET ADT10" + 
...
//				break;
	...
	public void populateFlipperSquad(PrintWriter print_writer, int whichSide, int teamId,String whichData, Auction auction, AuctionService auctionService, String session_selected_broadcaster) throws Exception {
		...
		case "squad":
			data_str.clear();
		//	data_str = AuctionFunctions.getSquadDataADT10InZone(auction,team_id);
...
//		int row = 0;
//		data_str.clear();
//		//data_str = AuctionFunctions.getSquadDataADT10InZone(match,team_id);
//		data_str = AuctionFunctions.getSquadDataADT10InZone(match,team_id);
//		List<String> count = new ArrayList<String>();
//		
//		Auction session_auction = match;

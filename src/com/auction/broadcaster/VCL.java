...
public class VCL extends Scene{

	private String status, side2ValueToProcess = "";
	private String slashOrDash = "-";
	public String session_selected_broadcaster = "VCL";
	...
	public VCL(String scene_path, String which_Layer) {
		...
		for(int i=auction.getPlayers().size()-1; i >= 0; i--) {
			if(playerId == auction.getPlayers().get(i).getPlayerId()) {
				...
				if(which_side == 2) {
					...
					print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$gfx_ScoreBug$MoveForStats$StatsGrp$Side" + which_side + "$Double_Data$txt_Age*GEOM*TEXT SET VCL" + 
...
//				break;
	...
	public void populateFlipperSquad(PrintWriter print_writer, int whichSide, int teamId,String whichData, Auction auction, AuctionService auctionService, String session_selected_broadcaster) throws Exception {
		...
		case "squad":
			data_str.clear();
		//	data_str = AuctionFunctions.getSquadDataVCLInZone(auction,team_id);
...
//		int row = 0;
//		data_str.clear();
//		//data_str = AuctionFunctions.getSquadDataVCLInZone(match,team_id);
//		data_str = AuctionFunctions.getSquadDataVCLInZone(match,team_id);
//		List<String> count = new ArrayList<String>();
//		
//		Auction session_auction = match;
...
//						}
	...
	public void populateProfileStats(PrintWriter print_writer, String whichType,int stat, int whichSide, Auction auction, AuctionService auctionService) {
		...
		case "CATEGORY":
			...
			print_writer.println("-1 RENDERER*FRONT_LAYER*TREE*$gfx_ScoreBug$StatsGrp$Side"+whichSide+"$Double_Data$txt_Text*GEOM*TEXT SET "+player.getCategory()+"\0");

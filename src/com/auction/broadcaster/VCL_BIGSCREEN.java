...
public class VCL_BIGSCREEN extends Scene{

	private String status, side2ValueToProcess = "";
	private String slashOrDash = "-";
	public String session_selected_broadcaster = "VCL_BIGSCREEN";
	...
	public VCL_BIGSCREEN() {
		super();
	}

	public VCL_BIGSCREEN(String scene_path, String which_Layer) {
	...
	public Data updateData(Auction auction, Auction session_curr_bid,AuctionService auctionService, PrintWriter print_writer) throws NumberFormatException, Exception
	{
		if(update_gfx == true) {
			if(which_graphics_onscreen.equalsIgnoreCase("IDENT")) {
				populateIdent(true,print_writer,whichSideNotProfile,session_selected_broadcaster, auctionService);
...
//						break;
			...
			AuctionService auctionService, String session_selected_broadcaster) throws InterruptedException 
	{
		...
		print_writer.println("-1 RENDERER*TREE*$gfx_FullFrames$Header$Side" + which_side + "$HeaderType1$txt_Header*GEOM*TEXT SET " + "VCL AUCTION 2025" + "\0");
